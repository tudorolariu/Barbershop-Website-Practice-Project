...
let bannerAppointmentsButton = document.getElementById(
  "bannerAppointmentsButton"
);
let menuAppointmentsButton = document.getElementById("menuAppointmentsButton");
let appointmentsAlertInitial =
  document.getElementsByClassName("appointmentsAlert");
let appointmentsAlertShown = document.getElementsByClassName(
  "appointmentsAlert shown"
);
let appointmentsAlertHidden = document.getElementsByClassName(
  "appointmentsAlert hidden"
);
let appointmentsAlertCloseButton = document.getElementById(
